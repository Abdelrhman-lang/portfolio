...
export default function LeftSidear() {
  ...
  return (
    <div className="left-sidebar-position md:border border-color rounded-lg md:p-5 text-white md:h-[650px] transition-all duration-200">
      <div
      ...
      <div className="px-2 mb-5 flex justify-center items-center">
        <img
          src="/boda-2.jpeg"
          alt="me"
      ...
      <h3 className="text-lg md:text-2xl text-center mb-5 font-light">
        Based in Egypt, CA
      </h3>
